import { FOLDER_ICON, PROPERTIES_ICON } from "@/assets/assets"
import { IGlobalDataFolder } from "@/context/redux/globalDataSlice"

const DisplayFolderHeader = ({
  displayData
}: {
...
export default DisplayFolderHeader
